...
app_filename=(_CPack_Packages/*/Bundle/gog-galaxy-social-*/OpenTTD-gog-galaxy-social.app)

if [ "${app_filename}" = "_CPack_Packages/*/Bundle/gog-galaxy-social-*/OpenTTD-gog-galaxy-social.app" ]; then
